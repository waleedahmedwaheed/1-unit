  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                ...
                <a class="brand" href="sign-in.php"><span class="first">1 - </span> <span class="second">Unit</span></a>
        </div>
    </div>
    ...
    <div class="dialog">
        <div class="block">
        <h1 style="color:#000; font-style:italic; margin-left:100px"> Admin Panel </h1>
