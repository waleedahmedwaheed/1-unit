...
$query_Recordset1 = "SELECT * FROM property where status=0";
...
<tbody>
		...
		<td><?php echo $row_Recordset1['bath']; ?></td>
				...
				<td> <a href="edit_posts.php?p_id=<?php echo $row_Recordset1['p_id']; ?>">Edit</a></td>
                <td> <a href="approve_posts.php?p_id=<?php echo $row_Recordset1['p_id']; ?>">Approve</a></td>
